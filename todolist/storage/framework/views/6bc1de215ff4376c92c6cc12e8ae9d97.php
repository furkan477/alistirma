...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <a href="<?php echo e(route('register_')); ?>" type="submit" name="sign_up" class="btn btn-primary btn-block">Sign Up</a>
  </div>
</div>
</body>
</html><?php /**PATH C:\xampp\htdocs\chatgpt\todolist\resources\views/auth/login.blade.php ENDPATH**/ ?>