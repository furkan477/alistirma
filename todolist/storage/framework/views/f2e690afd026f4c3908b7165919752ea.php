            ...
            <form action="<?php echo e(route('add')); ?>" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="task_explanation"></input>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary mt-3">Task Add</button>
...
</html><?php /**PATH C:\xampp\htdocs\chatgpt\todolist\resources\views/add.blade.php ENDPATH**/ ?>