...
<div class="wrapper">
    <div class="content-wrapper">
        ...
        <div class="content">
             <form action="{{route('updateBlog', ['id' => $data->id ])}}" method="post">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="blog_explanation" value="{{ $data->blog_explanation }}"></input>
                    </div>
                    <div class="form-group">
                        <label>Blog Type</label>
                        <input type="text" class="form-control" name="blog_type" value="{{ $data->blog_type }}">
                    </div>
