...
<div class="login-logo">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <a href="<?php echo e(route('login')); ?>" type="submit" name="login" class="btn btn-primary btn-block">Login</a>

  </div>
</div>
</body>
</html><?php /**PATH C:\xampp\htdocs\chatgpt\blogT\resources\views/auth/register.blade.php ENDPATH**/ ?>