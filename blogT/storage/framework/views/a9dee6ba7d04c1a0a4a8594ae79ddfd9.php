...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo e(route('UserAuth')); ?>" method="post">
        <?php echo csrf_field(); ?>
      ...
      <a href="<?php echo e(route('register')); ?>" type="submit" name="sign_up" class="btn btn-primary btn-block">Sign Up</a>
  </div>
</div>
</body>
</html><?php /**PATH C:\xampp\htdocs\chatgpt\blogT\resources\views/auth/login.blade.php ENDPATH**/ ?>