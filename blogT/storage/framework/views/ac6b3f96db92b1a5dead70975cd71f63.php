            ...
            <form action="<?php echo e(route('add')); ?>" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="blog_explanation"></input>
                    </div>
                    <div class="form-group">
                        <label>Blog Type</label>
                        <input type="text" class="form-control" name="blog_type">
                    </div>
                    <button type="submit" class="btn btn-primary mt-3">Blog Add</button>
...
</html><?php /**PATH C:\xampp\htdocs\chatgpt\blogT\resources\views/create.blade.php ENDPATH**/ ?>