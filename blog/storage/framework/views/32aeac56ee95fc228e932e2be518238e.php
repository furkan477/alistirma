...
<div class="wrapper">
    <div class="content-wrapper">
        ...
        <div class="content">
             <form action="<?php echo e(route('update' , ['id' => $blogs->id ])); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="form-group">
                        <label>Blog Name</label>
                        <input type="text" class="form-control" name="blog_name" value="<?php echo e($blogs->blog_name); ?>">
                    </div>
                    <div class="form-group">
                        <label>Blog Explanation</label>
                        <input type="text" class="form-control" name="blog_explanation" value="<?php echo e($blogs->blog_explanation); ?>"></input>
                    </div>
                    <div class="form-group">
                        <label>Blog Type</label>
                        <input type="text" class="form-control" name="blog_type" value="<?php echo e($blogs->blog_type); ?>">
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\chatgpt\blog\resources\views/update.blade.php ENDPATH**/ ?>