      ...
      <table class="table table-bordered">
                 ...
                 <thead>
                  ...
                  <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                    <tr>
                      <td><p><?php echo e($blog->id); ?></p></td>
                      <td><p><?php echo e($blog->blog_name); ?></p></td>
                      <td><p><?php echo e($blog->blog_explanation); ?></p></td>
                      <td><p><?php echo e($blog->blog_type); ?></p></td>
                      <td>
                        <div class="btn-group btn-group-md">
                          <button class="btn btn-md btn-info">List</button>
                          <a href="<?php echo e(route('delete' , ['id' => $blog->id])); ?>" class="btn btn-md btn-danger">Delete</a>
                          <a href="<?php echo e(route('updateView', ['id' => $blog->id])); ?>" class="btn btn-md btn-warning">Update</a>
                        </div>
                      </td>
                    </tr>  
...
</html><?php /**PATH C:\xampp\htdocs\chatgpt\blog\resources\views/list.blade.php ENDPATH**/ ?>