      ...
      <table class="table table-bordered">
                 ...
                 <thead>
                  ...
                  @foreach ($blogs as $blog)  
                    <tr>
                      <td><p>{{ $blog->id }}</p></td>
                      <td><p>{{ $blog->blog_name }}</p></td>
                      <td><p>{{ $blog->blog_explanation }}</p></td>
                      <td><p>{{ $blog->blog_type }}</p></td>
                      <td>
                        <div class="btn-group btn-group-md">
                          <button class="btn btn-md btn-info">List</button>
                          <a href="{{ route('delete' , ['id' => $blog->id]) }}" class="btn btn-md btn-danger">Delete</a>
                          <a href="{{route('updateView', ['id' => $blog->id]) }}" class="btn btn-md btn-warning">Update</a>
                        </div>
                      </td>
                    </tr>  
                  @endforeach                   
